...
public class TopService {
     ...
     */
    @Transactional
    public List<HC_M_FoodDto> selectFood(int foodTyle, String searchWord) {
        return foodDao.selectFoodByCond(foodTyle, this.zenkakuHiraganaToZenkakuKatakana(searchWord));
    }
